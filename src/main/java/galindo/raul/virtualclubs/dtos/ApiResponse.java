 ...
 * @param message      An {@link ErrorTypes} enum representing the error message if `success` is false,
 ...
 */
public record ApiResponse<T>(boolean success, ErrorTypes message, ResponseType responseType, T data) {}
